...
if (pin.status !== 'validated') errors.push(pin.blockedReason ?? 'No validated model profile is available.')
if (pin.candidateId !== null && !candidate) errors.push('Pinned candidate does not exist.')
if (candidate && (candidate.model !== pin.model || candidate.effort !== pin.effort || candidate.context !== pin.context)) {
