...
import { buildCorpus, detectRefusal, normalizedRequestForResponse, normalizeRequestEntries, parseCliArgs, readJson, retrieveExamples, validateRequest } from './lib.mjs'

const args = parseCliArgs(process.argv.slice(2))
if (!args.request) throw new Error('Usage: retrieve.mjs --request <request.json>')
...
if (errors.length) {
  ...
  console.log(JSON.stringify({ ok: results.every((result) => result.refusal === null), results }, null, 2))
}
