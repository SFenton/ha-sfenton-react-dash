...
| camera | modal | loading, live | Do camera tiles and modal media preserve their geometry while the Home Assistant HLS stream transitions from loading to decoded live video? |
