...
export const mockEntities: Record<string, MockEntity> = {
  ...
  'sensor.aqara_presence_multisensor_fp300_temperature_10': entity('sensor.aqara_presence_multisensor_fp300_temperature_10', '70.4', { unit_of_measurement: '°F' }),
  'sensor.aqara_presence_multisensor_fp300_temperature_8': entity('sensor.aqara_presence_multisensor_fp300_temperature_8', '69.8', { unit_of_measurement: '°F' }),
  'sensor.aqara_presence_multisensor_fp300_temperature_9': entity('sensor.aqara_presence_multisensor_fp300_temperature_9', '71.2', { unit_of_measurement: '°F' }),
  'cover.living_room_vents': entity('cover.living_room_vents', 'open'),
  'cover.kitchen_vent_vent': entity('cover.kitchen_vent_vent', 'open'),
  'binary_sensor.living_room_presence_sensor_occupancy': entity('binary_sensor.living_room_presence_sensor_occupancy', 'on'),
  'binary_sensor.aqara_presence_multisensor_fp300_occupancy_9': entity('binary_sensor.aqara_presence_multisensor_fp300_occupancy_9', 'off'),
  'binary_sensor.aqara_presence_multisensor_fp300_occupancy_5': entity('binary_sensor.aqara_presence_multisensor_fp300_occupancy_5', 'off'),
  'binary_sensor.aqara_presence_multisensor_fp300_occupancy_8': entity('binary_sensor.aqara_presence_multisensor_fp300_occupancy_8', 'off'),
