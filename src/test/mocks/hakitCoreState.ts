...
const adminPresenceSwitchEntityIds = [
  ...
  'switch.guest_room_presence_guest_room_lights_presence_allowed',
  'switch.office_presence_office_light_presence_allowed',
  'switch.master_bedroom_presence_master_bedroom_lights_presence_allowed',
  ...
  'switch.theater_room_presence_theater_room_lights_presence_allowed',
