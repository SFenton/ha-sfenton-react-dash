...
export const mockEntities: Record<string, MockEntity> = {
  ...
  'select.valetudo_elatedusedram_mode': entity('select.valetudo_elatedusedram_mode', 'unavailable'),
  'select.valetudo_elatedusedram_fan': entity('select.valetudo_elatedusedram_fan', 'unavailable'),
  'select.valetudo_elatedusedram_water': entity('select.valetudo_elatedusedram_water', 'unavailable'),
  'input_select.music_room_vacuum_cleaning_passes': entity('input_select.music_room_vacuum_cleaning_passes', '1'),
  ...
  'select.valetudo_politefatherlykingfisher_fan': entity('select.valetudo_politefatherlykingfisher_fan', 'balanced'),
  'input_select.theater_room_vacuum_cleaning_passes': entity('input_select.theater_room_vacuum_cleaning_passes', '1'),
  ...
  'select.valetudo_exaltedsneakydeer_mode': entity('select.valetudo_exaltedsneakydeer_mode', 'vacuum'),
  'select.valetudo_exaltedsneakydeer_fan': entity('select.valetudo_exaltedsneakydeer_fan', 'balanced'),
  'select.valetudo_exaltedsneakydeer_water': entity('select.valetudo_exaltedsneakydeer_water', 'medium'),
  'input_select.main_floor_vacuum_cleaning_passes': entity('input_select.main_floor_vacuum_cleaning_passes', '1'),
