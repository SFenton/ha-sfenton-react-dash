...
import { VACUUM_AREA_EDITOR_MODAL_STYLE, VACUUM_MODAL_STYLE, VACUUM_OUTCOME_MODAL_STYLE } from './vacuumModalStyle'
...
export function VacuumModal({
  ...
  return (
    <ModalSheet
      ...
      contentStyle={areaEditorOpen ? VACUUM_AREA_EDITOR_MODAL_STYLE : showOutcomes ? VACUUM_OUTCOME_MODAL_STYLE : VACUUM_MODAL_STYLE}
      footer={areaEditorOpen || showOutcomes ? undefined : <VacuumModalNav activeTab={activeTab} onTabChange={(tab) => {
        if (tab === 'zones') setCleanTarget('rooms')
        setActiveTab(tab)
      }} vacuum={vacuum} />}
