...
describe('BathroomFanModalContent', () => {
  ...
  it('renders read-only room status and hides timer controls while power is off', () => {
    ...
    expect(hint).toHaveTextContent('Double tapping On on the fan switch will lock the fan on.')
    expect(hint).toHaveTextContent('Double tapping Off on the fan switch will lock the fan off.')
