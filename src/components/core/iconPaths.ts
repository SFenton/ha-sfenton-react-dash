...
const MATERIAL_ICON_PATHS: Record<string, string> = {
  ...
  'mdi:broom': mdiBroom,
  'mdi:brush': mdiBrush,
  'mdi:brush-variant': mdiBrushVariant,
  ...
  'mdi:minus': mdiMinus,
  'mdi:minus-box-outline': mdiMinusBoxOutline,
  ...
  'mdi:robot-vacuum-off': mdiRobotVacuumOff,
  'mdi:selection-drag': mdiSelectionDrag,
  ...
  'mdi:shaker-outline': mdiShakerOutline,
  ...
  'mdi:vector-rectangle': mdiVectorRectangle,
