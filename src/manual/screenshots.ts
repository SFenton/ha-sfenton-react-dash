...
export const MANUAL_SCREENSHOTS: ManualScreenshotConfig[] = [
  ...
  },
  {
    ...
    requiredTargets: ['Rooms', 'Automation', 'Tracking', 'Open Room Thermostats', 'Open Automation', 'Open Room Tracking'],
    privacyClass: 'synthetic',
    desktopMaxWidth: 820,
    mobileMaxWidth: 310,
    ...
    landingUse: {
      sectionId: 'climate',
      caption: 'The Climate page explains Rooms, Automation, and Tracking before opening the matching tab in one shared sheet.',
    },
    alt: 'Rooms, Automation, and Tracking entry points with explanatory text and synthetic state summaries.',
    caption: 'Each Climate entry explains what opens before navigating directly to its matching Thermostat tab.',
  },
  {
  ...
  },
  {
    ...
    requiredTargets: ['Whole Home', 'Rooms', 'Automation', 'Tracking'],
    privacyClass: 'synthetic',
    desktopMaxWidth: 820,
    alsoUsedByArticleIds: [
    ...
    alt: 'Climate page showing the Whole Home thermostat and the three explained Thermostat entry points.',
    caption: 'The Climate page keeps the Whole Home dial visible and provides direct entry to Rooms, Automation, and Tracking.',
  },
  {
    id: 'chore-schedule',
