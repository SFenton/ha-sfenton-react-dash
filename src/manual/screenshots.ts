...
export const MANUAL_SCREENSHOTS: ManualScreenshotConfig[] = [
  ...
  },
  {
    ...
    requiredTargets: ['Rooms & Settings', 'Thermostat Controls', '11 rooms'],
    privacyClass: 'synthetic',
    desktopMaxWidth: 820,
    mobileMaxWidth: 310,
    cropSelector: 'section:has([data-manual-visible-section="Rooms & Settings"])',
    cropHeight: 150,
    alsoUsedByArticleIds: ['thermostat-page-guide'],
    landingUse: {
      sectionId: 'climate',
      caption: 'Rooms & Settings opens the shared Thermostat sheet without adding secondary configuration to the route scroll.',
    },
    alt: 'Rooms and Settings opener showing the synthetic room count and whole-home climate range.',
    caption: 'Rooms & Settings opens the shared Thermostat sheet without adding secondary configuration to the route scroll.',
  },
  {
  ...
  },
  {
    ...
    requiredTargets: ['Whole Home', 'Rooms & Settings'],
    privacyClass: 'synthetic',
    desktopMaxWidth: 820,
    alsoUsedByArticleIds: [
    ...
    alt: 'Climate page showing the whole-home thermostat and the Rooms and Settings opener.',
    caption: 'The short Climate page keeps the Whole Home dial and opens rooms, automation, and tracking from one shared sheet.',
  },
  {
    id: 'chore-schedule',
