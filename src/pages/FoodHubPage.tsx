...
import { SuggestedRecipeCarousel } from '../components/hass/recipes/SuggestedRecipeCarousel'
  ...
  return (
    <div className={styles.stack}>
      <section className={styles.section} id="section-suggested-recipes">
        ...
        <SuggestedRecipeCarousel preload={preload} />
      </section>
      ...
      <section aria-label="All Recipes" className={styles.fullWidthTile}>
        <GlassTile
          ...
          subtitle="Browse the complete recipe catalog"
          title="All Recipes"
        />
      </section>
