...
export const CLIMATE_GROUPS: EntityGroupConfig[] = [
  {
    ...
    items: [
      ...
      { title: 'Bar', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_10', colorEntityId: 'input_text.living_room_bar_climate_color', tone: 'climate' },
      { title: 'Kitchen Wall', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_8', colorEntityId: 'input_text.living_room_kitchen_wall_climate_color', tone: 'climate' },
      { title: 'Fireplace', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_9', colorEntityId: 'input_text.living_room_fireplace_climate_color', tone: 'climate' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Closet', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_5', colorEntityId: 'input_text.guest_room_closet_climate_color', tone: 'climate' },
  ...
  },
  {
    ...
    items: [
      { title: 'Window', entityId: 'sensor.master_bedroom_window_presence_sensor_temperature_2', colorEntityId: 'input_text.master_bedroom_window_climate_color', tone: 'climate' },
      { title: 'Bathroom', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature', colorEntityId: 'input_text.master_bedroom_bathroom_climate_color', tone: 'climate' },
      { title: 'Closet', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_2', colorEntityId: 'input_text.master_bedroom_closet_climate_color', tone: 'climate' },
  ...
  },
  {
    ...
    items: [
      { title: 'Entry', entityId: 'sensor.hallway_entryway_living_room_presence_sensor_temperature', colorEntityId: 'input_text.entryway_climate_color', tone: 'climate' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Presence', entityId: 'sensor.office_presence_sensor_temperature_2', colorEntityId: 'input_text.office_presence_climate_color', tone: 'climate' },
      { title: 'Closet', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_3', colorEntityId: 'input_text.office_closet_climate_color', tone: 'climate' },
  ...
  },
  {
    ...
    items: [
      { title: 'Kitchen', entityId: 'sensor.kitchen_presence_sensor_temperature', colorEntityId: 'input_text.kitchen_presence_climate_color', tone: 'climate' },
  ...
  },
  {
    ...
    items: [
      { title: 'Kitchenette', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_12', colorEntityId: 'input_text.music_room_kitchenette_climate_color', tone: 'climate' },
      { title: 'North Wall', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_11', colorEntityId: 'input_text.music_room_north_wall_climate_color', tone: 'climate' },
      { title: 'Door', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_13', colorEntityId: 'input_text.music_room_door_climate_color', tone: 'climate' },
  ...
  },
  {
    ...
    items: [
      { title: 'Presence', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_14', colorEntityId: 'input_text.theater_room_presence_sensor_climate_color', tone: 'climate' },
  ...
  },
  {
    ...
    items: [{ title: 'Presence', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_7', colorEntityId: 'input_text.downstairs_hallway_climate_color', tone: 'climate' }],
  },
  {
    ...
    items: [
      ...
      { title: 'Entry', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_4', colorEntityId: 'input_text.guest_bathroom_entry_climate_color', tone: 'climate' },
  ...
  },
  {
    ...
    items: [
      { title: 'Presence', entityId: 'sensor.master_bathroom_presense_sensor_temperature', colorEntityId: 'input_text.master_bathroom_presence_climate_color', tone: 'climate' },
  ...
  },
  {
    ...
    items: [{ title: 'Front Door', entityId: 'sensor.aqara_presence_multisensor_fp300_temperature_6', colorEntityId: 'input_text.entryway_climate_color', tone: 'climate' }],
  },
]
...
export const OCCUPANCY_GROUPS: EntityGroupConfig[] = [
  {
    ...
    items: [
      { title: 'Back Wall', entityId: 'binary_sensor.living_room_presence_sensor_occupancy', tone: 'presence' },
      { title: 'Bar', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_9', tone: 'presence' },
      { title: 'Kitchen Wall', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_5', tone: 'presence' },
      { title: 'Fireplace', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_8', tone: 'presence' },
    ],
  },
  {
    title: 'Hallway Occupancy',
    items: [
      { title: 'Entryway', entityId: 'binary_sensor.hallway_entryway_living_room_presence_sensor_occupancy', tone: 'presence' },
      { title: 'Bathroom', entityId: 'binary_sensor.hallway_guest_bath_gym_presence_sensor_occupancy', tone: 'presence' },
      { title: 'Office', entityId: 'binary_sensor.hallway_office_bedroom_presence_sensor_occupancy', tone: 'presence' },
    ],
  },
  {
    title: 'Kitchen Occupancy',
    items: [{ title: 'Kitchen', entityId: 'binary_sensor.kitchen_presence_sensor_occupancy', tone: 'presence' }],
  },
  {
    title: 'Guest Room Occupancy',
    items: [
      { title: 'Guest Room', entityId: 'binary_sensor.guest_room_presence_sensor_occupancy', tone: 'presence' },
      { title: 'Closet', entityId: 'binary_sensor.guest_room_closet_facing_presence_sensor_occupancy', tone: 'presence' },
    ],
  },
  {
    title: 'Gym Occupancy',
    items: [{ title: 'Gym', entityId: 'binary_sensor.gym_presence_sensor_occupancy', tone: 'presence' }],
  },
  {
    title: 'Office Occupancy',
    items: [
      { title: 'Office', entityId: 'binary_sensor.office_presence_sensor_occupancy', tone: 'presence' },
      { title: 'Closet', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_3', tone: 'presence' },
    ],
  },
  {
    title: 'Master Bedroom Occupancy',
    items: [
      { title: 'Master Bedroom', entityId: 'binary_sensor.master_bedroom_window_presence_sensor_occupancy', tone: 'presence' },
      { title: 'Bathroom', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy', tone: 'presence' },
      { title: 'Closet', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_2', tone: 'presence' },
    ],
  },
  {
    title: 'Guest Bathroom Occupancy',
    items: [
      { title: 'Guest Bathroom', entityId: 'binary_sensor.guest_bathroom_presence_sensor_occupancy', tone: 'presence' },
      { title: 'Entry', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_4', tone: 'presence' },
    ],
  },
  {
    title: 'Master Bathroom Occupancy',
    items: [{ title: 'Master Bathroom', entityId: 'binary_sensor.master_bathroom_presense_sensor_occupancy', tone: 'presence' }],
  },
  {
    title: 'Music Room Occupancy',
    items: [
      { title: 'North Wall', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_10', tone: 'presence' },
      { title: 'Kitchenette', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_11', tone: 'presence' },
      { title: 'Door', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_12', tone: 'presence' },
    ],
  },
  {
    title: 'Dining Room Occupancy',
    items: [{ title: 'Dining Room', entityId: 'binary_sensor.dining_room_presence_sensor_occupancy', tone: 'presence' }],
  },
  {
    title: 'Theater Room Occupancy',
    items: [{ title: 'Theater Room', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_13', tone: 'presence' }],
  },
  {
    title: 'Entryway Occupancy',
    items: [{ title: 'Front Door', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_6', tone: 'presence' }],
  },
  {
    title: 'Downstairs Hallway Occupancy',
    items: [{ title: 'Downstairs Hallway', entityId: 'binary_sensor.aqara_presence_multisensor_fp300_occupancy_7', tone: 'presence' }],
  },
]
