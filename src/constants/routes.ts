...
export const DASHBOARD_ROUTES: DashboardRouteConfig[] = [
  ...
  { title: 'Guest Room', path: 'guest-room', icon: 'mdi:bed-single' },
  ...
  { title: 'Office', path: 'office', icon: 'mdi:laptop-account' },
  { title: 'Kitchen', path: 'kitchen', icon: 'mdi:pot-steam' },
  { title: 'Dining Room', path: 'dining-room', icon: 'mdi:silverware-fork-knife' },
  { title: 'Back Deck', path: 'back-deck', icon: 'mdi:grill' },
  { title: 'Music Room', path: 'music-room', icon: 'mdi:guitar-electric' },
  { title: 'Theater Room', path: 'theater-room', icon: 'mdi:projector' },
  { title: 'Downstairs Hallway', path: 'downstairs-hallway', icon: 'mdi:wardrobe-outline' },
  { title: 'Garage', path: 'garage', icon: 'mdi:car' },
  { title: 'Guest Bathroom', path: 'guest-bathroom', icon: 'mdi:shower' },
  { title: 'Master Bathroom', path: 'master-bathroom', icon: 'mdi:shower-head' },
