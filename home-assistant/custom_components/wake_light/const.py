...
POST_WAKE_HOLD_MINUTE_OPTIONS = (5, 10, 15, 30)
MIN_RAMP_MINUTES = 0
MAX_RAMP_MINUTES = 60
MIN_POST_WAKE_HOLD_MINUTES = 5
MAX_POST_WAKE_HOLD_MINUTES = 30
...
OP_SET_SOURCE_SUSPENSION = "set_source_suspension"
COMMAND_OPERATIONS = {
    OP_UPSERT_ALARM,
    OP_DELETE_ALARM,
    OP_UPDATE_DEFAULTS,
...
OUTCOME_OWNER_MISMATCH = "owner_mismatch"
